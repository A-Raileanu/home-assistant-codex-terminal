---
name: ha-refactoring
description: Entry point rapid pentru redenumiri si refactoring Home Assistant: impact analysis, referinte stale, dashboards storage, config entries si rename_memory.json.
---
...
5. Verifica automatizari, scripturi, scene, groups/helpers, dashboards YAML, `.storage/lovelace*`, `customize`, template-uri si integrari externe.
