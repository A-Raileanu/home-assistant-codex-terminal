...
description: Punct de pornire pentru notificări Home Assistant: `notify.send_message`, destinații, canale, priorități, acțiuni mobile, TTS și Jinja sigur.
---

# Notificari — Punct de pornire
...
3. Pentru șabloane in notificari, adauga fallback-uri sigure pentru stari `unknown`/`unavailable`.
...
|---|---|
| Canale si prioritati mobile | [references/ha-notifications.md](references/ha-notifications.md#canale-channel) |
| Notificari actionabile | [references/ha-notifications.md](references/ha-notifications.md#notificări-acționabile-actions) |
